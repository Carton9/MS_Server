 ...
 *
 */
public class HTTPResourceCentor {
	enum HTTPCode{
	...
	GeneralCache<HTTPCase> IO_ParserCache;
	GeneralCache<HTTPCase> Parser_AnalysisterCache;
	GeneralCache<HTTPCase> Analysister_IOCache;
	GeneralCache<HTTPCase> backEndCache;
	String iDString;
	public HTTPResourceCentor() {
